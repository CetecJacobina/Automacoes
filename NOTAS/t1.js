(async function () {
    ...
    function exportarParaExcel() {
        let alunos = [];
        let licao = document.querySelector("td strong")?.textContent.trim() || "Licao";
        ...
        // Percorre as linhas para capturar tempos e quizzes
        ...
        XLSX.writeFile(wb, `${licao}.xlsx`);
        console.log("Arquivo exportado:", `${licao}.xlsx`);
    }
})();
